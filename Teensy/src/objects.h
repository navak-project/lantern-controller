...
AudioSynthWaveformSine   sineAM;         //xy=915,603
...
AudioMixer4              staticMixer;    //xy=1253,453
AudioFilterStateVariable lanternLoopFilter; //xy=1353,46
AudioPlaySdWav           lanternEvents;  //xy=1376,128
AudioMixer4              hbMixer;        //xy=1399,340
AudioEffectDelay         noiseDly;       //xy=1456,615
AudioMixer4              preDlyMixer;    //xy=1457,729
...
AudioConnection          patchCord33(mainMixer, ampOut);
AudioConnection          patchCord34(ampOut, 0, i2sOut, 0);
AudioConnection          patchCord35(ampOut, 0, i2sOut, 1);
AudioControlSGTL5000     sgtl5000_1; //xy=870,54
